...
public class NumbersLambda {
	...
	public static Function<Integer, Integer> policy() {
		// TODO: Task 3
		return x -> Boolean.compare(isOdd().test(x), false) * 1 + Boolean.compare(isPrime().test(x), false) * 2
	...
	public static Predicate<Integer> isPrime() {
		// TODO: Task 2
		return x -> x % 2 != 0 && IntStream.range(2, x - 1).noneMatch(divisor -> x % divisor == 0);
	}
